...
| `status`        | text         | &check;  | Trạng thái người dùng: CREATED, ACTIVE, DELETED |
...
| `status`             | text         | &check;  | Trạng thái khu trọ: CREATED, ACTIVE, DELETED |
| `created_at`         | timestamp    | &check;  | Thời gian khởi tạo                           |
| `updated_at`         | timestamp    | &check;  | Thời gian cập nhật                           |
...
| `status`      | text         | &check;  | Trạng thái dãy trọ: ACTIVE, DELETED | 
| `created_at`  | timestamp    | &check;  | Thời gian khởi tạo                  |
| `updated_at`  | timestamp    | &check;  | Thời gian cập nhật                  |
...
| `property_id` | uuid         | &check;  | ID của khu trọ                       |
| `status`      | text         | &check;  | Trạng thái tầng trọ: ACTIVE, DELETED |
| `created_at`  | timestamp    | &check;  | Thời gian khởi tạo                   |
| `updated_at`  | timestamp    | &check;  | Thời gian cập nhật                   |
...
| `status`      | text         | &check;  | Trạng thái phòng trọ: ACTIVE, DELETED |
| `created_at`  | timestamp    | &check;  | Thời gian khởi tạo                    |
| `updated_at`  | timestamp    | &check;  | Thời gian cập nhật                    |
...
| `property_id`    | uuid         | &check;  | ID của khu trọ                                |
| `status`         | text         | &check;  | Trạng thái: ACTIVE, DELETED                   |
| `created_at`     | timestamp    | &check;  | Thời gian khởi tạo                            |
| `updated_at`     | timestamp    | &check;  | Thời gian cập nhật                            |
...
| `note`             | text         | &cross;  | Ghi chú                            |
| `status`           | text         | &check;  | Trạng thái: ACTIVE, ENDED, DELETED |
| `created_at`       | timestamp    | &check;  | Thời gian khởi tạo                 |
| `updated_at`       | timestamp    | &check;  | Thời gian cập nhật                 |
...
| `note`                  | text         | &cross;  | Ghi chú                           |
| `status`                | text         | &check;  | Trạng thái: ACTIVE, PAID, DELETED |
| `created_at`            | timestamp    | &check;  | Thời gian khởi tạo                |
| `updated_at`            | timestamp    | &check;  | Thời gian cập nhật                |
