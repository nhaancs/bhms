...
# 	$ kubectl logs --namespace=realworld-system -l app=api -c init-vault-server
...
KIND_CLUSTER    := realworld-cluster
NAMESPACE       := realworld-system
APP             := api
BASE_IMAGE_NAME := nhaancs/realworld
SERVICE_NAME    := api
VERSION         := 0.0.1
